...
# Chỉnh múi giờ về Việt Nam (để ngày giờ mượn trả chính xác)
...
# Sau khi đăng nhập thành công, tự động chuyển hướng về trang afterlogin
LOGIN_REDIRECT_URL = 'afterlogin'

# Đường dẫn trang đăng nhập (để @login_required biết đường chuyển hướng khi chưa đăng nhập)
